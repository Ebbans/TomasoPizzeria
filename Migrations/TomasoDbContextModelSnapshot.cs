...
namespace Inlämning1Tomaso.Migrations
{
    ...
    partial class TomasoDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inlämning1Tomaso.Data.Models.OrderDish", b =>
                {
                    b.Property<int>("OrderID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Inlämning1Tomaso.Data.Models.User", b =>
                {
                    b.Property<int>("UserID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Inlämning1Tomaso.Data.Models.Dish", b =>
                {
                    b.HasOne("Inlämning1Tomaso.Data.Models.Category", null)
                        .WithMany("Dishes")
            ...
            modelBuilder.Entity("Inlämning1Tomaso.Data.Models.Order", b =>
                {
                    b.HasOne("Inlämning1Tomaso.Data.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Inlämning1Tomaso.Data.Models.OrderDish", b =>
                {
                    ...
                    b.HasOne("Inlämning1Tomaso.Data.Models.Order", "Order")
                        .WithMany("OrderDishes")
